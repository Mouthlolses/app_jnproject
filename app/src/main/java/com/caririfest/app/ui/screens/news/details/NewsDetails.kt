package com.caririfest.app.ui.screens.news.details
...
import com.caririfest.app.shared.shareContent
import com.caririfest.app.ui.components.BuyTicketButtonBar
...
fun NewsDetailsLayout(
    ...
    val tagList = List(20) { event.fields.favorite.booleanValue }
